...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="所有量表">
          <a class="nav-link" href="{{url('/site/scales')}}">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">所有量表</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="歷程記錄">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('site/logout') }}" data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="content-wrapper">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>NCNUIM © ScaleService</small>
        </div>
      </div>
    </footer>
    ...
    <script src="{{url('')}}/vendor2/chart.js/Chart.min.js"></script>
    <script src="{{url('')}}/vendor2/datatables/jquery.dataTables.js"></script>
    <script src="{{url('')}}/vendor2/datatables/dataTables.bootstrap4.js"></script>

...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{url('')}}/sitevendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>

    <!-- Plugin CSS -->
    <link href="{{url('')}}/sitevendor/magnific-popup/magnific-popup.css" rel="stylesheet">
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">準備開始</a>
            </li>
            <li class="nav-item">
    ...
    <script src="{{url('')}}/sitevendor/jquery/jquery.min.js"></script>
    <script src="{{url('')}}/sitevendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Plugin JavaScript -->
    <script src="{{url('')}}/sitevendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="{{url('')}}/sitevendor/scrollreveal/scrollreveal.min.js"></script>
    <script src="{{url('')}}/sitevendor/magnific-popup/jquery.magnific-popup.min.js"></script>
